...
for c, d in enumerate(uniq_diag):
    ...
    with tf.Graph().as_default():
        ...
        model.save('Saved_Models/Fully_Connected_n_epochs_{0}/dense_fully_connected_dropout_5645_{1}.tfl'
                   .format(n_epoch, d))
...
print('ROC Plot saved at ../Results_tfidf/Dense_fully_connected/Plots/ROC_' + name)
print("--------------------Training Done!!!--------------------")
...
plt.savefig('../Results_tfidf/Dense_fully_connected/Plots/ROC_' + name + '.png')
