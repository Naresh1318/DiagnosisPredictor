...
for c, d in enumerate(uniq_diag):
    ...
    joblib.dump(sc, 'Saved_Models/KNN_tfidf/standard.pkl')
    ...
    joblib.dump(knn, 'Saved_Models/KNN_tfidf/knn_nn_{0}_{1}.pkl'.format(n_neighbors, d))
...
print('ROC Plot saved at ../Results_tfidf/KNN/Plots/ROC_' + name)
print("--------------------Training Done!!!--------------------")
...
plt.savefig('../Results_tfidf/KNN/Plots/ROC_' + name + '.png')
