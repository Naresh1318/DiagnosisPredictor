...
for c, d in enumerate(uniq_diag):
    ...
    joblib.dump(sc, 'Saved_Models/Logistic_Regression/sd/standard.pkl')
    ...
    # Save the model
    joblib.dump(lr, 'Saved_Models/Logistic_Regression/sd/lr_{}.pkl'.format(d))
...
print('ROC Plot saved at ../Results_word2vec/Logistic_regression/sd/Plots/ROC_' + name)
print("--------------------Training Done!!!--------------------")
...
plt.savefig('../Results_word2vec/Logistic_regression/sd/Plots/ROC_' + name + '.png')
